...
<body id="page-top">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link js-scroll-trigger"
						...
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="#sis_photo">독서실</a></li>
					<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="#portfolio">겔러리</a></li>
					<li class="nav-item"><a class="nav-link js-scroll-trigger"
	...
	<section id="sis_photo">
	<header class="masthead" style="background-image: url(images/sis_photo1.png); width:100%; height: 100%; min-height: 500px;  background-attachment:inherit;">
	</header>
	<header class="masthead" style="background-image: url(images/sis_photo2.png); width:100%; height: 100%; min-height: 750px; background-attachment:inherit;">
	</header>
	</section>
			...
			<div class="row no-gutter popup-gallery">
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="images/portfolio/fullsize/3.jpg">
						...
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">OPEN STUDY
									ROOM</div>
