						...
						function(result, status) {
							...
							if (status === daum.maps.services.Status.OK) {
								...
								var content = '<div class="customoverlay">'
										...
										+ '    <span class="title">Smart In Study</span>'
										+ '  </a>'
							...
							// 본사
							var dkpos1 = new daum.maps.LatLng(
									37.439004547500836, 126.67514316814552);

							// 툴팁을 노출하는 마커를 생성합니다.
							var marker1 = new TooltipMarker(dkpos1, 'Smart In Study');
							/*  marker1.setMap(map); */
