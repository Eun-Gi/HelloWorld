...
public class SisBean {
	...
	private String sisroomType;
	private int sirprice;
	...
	public int getSirprice() {
		return sirprice;
	}
	public void setSirprice(int sirprice) {
		this.sirprice = sirprice;
	}
	public String getSisroomType() {
		return sisroomType;
	}
	public void setSisroomType(String sisroomType) {
		this.sisroomType = sisroomType;
	}
